<template>
  <div>
    ...
    <div style="width: 100%; height: 60px; line-height: 60px; background-color: white" >
      <el-row>
        <el-col :span="4">
          <div style="font-size: 20px; font-weight: bold; text-align: center"><a style="color: #409EFF;" href="/front/home">校园二手交易平台</a></div>
        </el-col>
        <el-col :span="10">
          ...
          <div style="text-align: right; padding-right: 10px" v-if="user.id">
            <el-dropdown style="float: right;" @command="handleCommand">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item command="return">返回后台</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </div>
...
export default {
  ...
  created() {//在组件创建时调用，从 sessionStorage 中获取用户信息并存储在 user 属性中。
    this.user = sessionStorage.getItem("user") ? JSON.parse(sessionStorage.getItem("user")) : {}
  },
  methods: {//定义了组件的方法，包括搜索、处理命令、处理菜单选择等功能。
    search() {
